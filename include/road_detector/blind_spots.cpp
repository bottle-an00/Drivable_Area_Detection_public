...
int params::xDirection =0;     //direction of the blindspot cutoff
bool params::blind_spots = true;   //enable blindspot correction
float params::beamZone = 30;     //size of hte examined beamzone
