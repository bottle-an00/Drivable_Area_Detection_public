...
struct polar_    //polar_-coordinate struct for the points
{
...
{
    vector<polar_> p; //points within the beam's area
...
class Detector{
    ...
    void filtered(pcl::PointCloud<pcl::PointXYZI>::Ptr ground_cloud, pcl::PointCloud<pcl::PointXYZI>::Ptr Road_cloud, pcl::PointCloud<pcl::PointXYZI>::Ptr Curb_cloud);
