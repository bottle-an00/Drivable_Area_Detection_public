...
float params::angleFilter1 =0.2;     //angle given by three points, while keeping X = 0
float params::curbHeight = 0.05;       //estimated minimal height of the curb
int params::curbPoints = 5;         //estimated number of points on the curb
